...

{
	...
	bool DepthMap::create(const TextureParameters& params)
	{
		...
		else if (params.m_type == TextureParameters::DEPTH_CUBEMAP)
		{
			...
			glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MAG_FILTER, GL_LINEAR); GL_DEBUG;
			glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_FILTER, GL_LINEAR); GL_DEBUG;
